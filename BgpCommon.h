...
const unsigned char NB_TIMERS = 5;	// modify config parameters to 5 (original 4) add by xxl
const unsigned char NB_STATS = 8;	// modify statics parameters to 8 (original 6) add by xxl
