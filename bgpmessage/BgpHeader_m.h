...
/**
 * Class generated from <tt>inet/routing/bgpv4/bgpmessage/BgpHeader.msg:99</tt> by nedtool.
 * <pre>
 * //
 * // Represents a BGPv4 NOTIFICATION message.
 * //
 * // NOTIFICATION messages are exchanged as often as necessary between systems
 * // to notify peers that one router is error.
 * // add by xxl
 * //
 * class BgpNotificationMessage extends BgpHeader
 * {
 ...
 * </pre>
 */
class INET_API BgpNotificationMessage : public ::inet::bgp::BgpHeader
{
  protected:
    uint16_t myAS = 0;

  private:
    void copy(const BgpNotificationMessage& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const BgpNotificationMessage&);

  public:
    BgpNotificationMessage();
    BgpNotificationMessage(const BgpNotificationMessage& other);
    virtual ~BgpNotificationMessage();
    BgpNotificationMessage& operator=(const BgpNotificationMessage& other);
    virtual BgpNotificationMessage *dup() const override {return new BgpNotificationMessage(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const BgpNotificationMessage& obj) {obj.parsimPack(b);}
