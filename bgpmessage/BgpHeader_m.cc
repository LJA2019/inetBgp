...
Register_Class(BgpNotificationMessage)

BgpNotificationMessage::BgpNotificationMessage() : ::inet::bgp::BgpHeader()
{
    this->setType(BGP_NOTIFICATION);

}

BgpNotificationMessage::BgpNotificationMessage(const BgpNotificationMessage& other) : ::inet::bgp::BgpHeader(other)
{
    copy(other);
}
...
BgpNotificationMessage& BgpNotificationMessage::operator=(const BgpNotificationMessage& other)
{
    if (this == &other) return *this;
    ::inet::bgp::BgpHeader::operator=(other);
    copy(other);
...
void BgpNotificationMessage::copy(const BgpNotificationMessage& other)
{
    this->myAS = other.myAS;
}

void BgpNotificationMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::bgp::BgpHeader::parsimPack(b);
    doParsimPacking(b,this->myAS);
}

void BgpNotificationMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::bgp::BgpHeader::parsimUnpack(b);
    doParsimUnpacking(b,this->myAS);
}

uint16_t BgpNotificationMessage::getMyAS() const
{
    return this->myAS;
}

void BgpNotificationMessage::setMyAS(uint16_t myAS)
{
    handleChange();
    this->myAS = myAS;
}

class BgpNotificationMessageDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
    enum FieldConstants {
  ...
  public:
    BgpNotificationMessageDescriptor();
    virtual ~BgpNotificationMessageDescriptor();
...
Register_ClassDescriptor(BgpNotificationMessageDescriptor)

BgpNotificationMessageDescriptor::BgpNotificationMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::bgp::BgpNotificationMessage)), "inet::bgp::BgpHeader")
{
    propertynames = nullptr;
}

BgpNotificationMessageDescriptor::~BgpNotificationMessageDescriptor()
{
    delete[] propertynames;
}

bool BgpNotificationMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<BgpNotificationMessage *>(obj)!=nullptr;
}

const char **BgpNotificationMessageDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *BgpNotificationMessageDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int BgpNotificationMessageDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount() : 1;
}

unsigned int BgpNotificationMessageDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *BgpNotificationMessageDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int BgpNotificationMessageDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'm' && strcmp(fieldName, "myAS") == 0) return base+0;
    return basedesc ? basedesc->findField(fieldName) : -1;
}

const char *BgpNotificationMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **BgpNotificationMessageDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *BgpNotificationMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int BgpNotificationMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    BgpNotificationMessage *pp = (BgpNotificationMessage *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *BgpNotificationMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string BgpNotificationMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool BgpNotificationMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *BgpNotificationMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *BgpNotificationMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
